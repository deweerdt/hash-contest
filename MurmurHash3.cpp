...
#define _rotl(v, n)   (T32((v) << ((n)&0x1F)) | \
			T32((v) >> (32 - ((n)&0x1F))))

#define _rotr(v, n)   (T32((v) >> ((n)&0x1F)) | \
			T32((v) << (32 - ((n)&0x1F))))



#define ONE64   (0xFFFFFFFFFFFFFFFFLL)

#define T64(x)  ((x) & ONE64)

#define _rotl64(v, n)   (T64((v) << ((n)&0x3F)) | \
			T64((v) >> (64 - ((n)&0x3F))))

#define _rotr64(v, n)   (T64((v) >> ((n)&0x3F)) | \
			T64((v) << (64 - ((n)&0x3F))))
